...
camerasdict["UI3860"] = PhaseRetrieval.CameraChip(pixelsize = 2.9E-3, imagesize = (1936, 1096), bitdepth = 12, channelbitdepth = 16) #Bit depth of the images is 16
camerasdict["MC203MG"] = PhaseRetrieval.CameraChip(pixelsize = 2.74E-3, imagesize = (4504, 4504), bitdepth = 12, channelbitdepth = 16) #Bit depth of the images is 16
